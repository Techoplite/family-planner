    ...
    return (
        <Switch>
            ...
            so feel free to sign up with a dummy email and password.</p>
                ...
                <p>You could also join the "Doe family", but I am afraid they have already reached the maximum number of members that can register within a family (9). Anyway if you wan to check for validation their password is "doepass1".</p>
